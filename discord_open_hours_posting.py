...
EVENT_DETAILS = {
    calendar.TUESDAY: {"time": datetime.time(hour=18, minute=0), "duration": 120},
    calendar.THURSDAY: {"time": datetime.time(hour=18, minute=0), "duration": 120},
    calendar.SUNDAY: {"time": datetime.time(hour=14, minute=0), "duration": 240},
